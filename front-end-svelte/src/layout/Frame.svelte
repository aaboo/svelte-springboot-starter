...
//dispatch 관련
const paramFromSearch = {};
let idFromMenu = '';

//조회
function paramFromSearchFunc(ev){     
    paramFromSearch[$menuStore.currentMenuCID] = ev.detail.paramFromSearch;
}
    ...
    <content>
                    ...
                    {#each $menuStore.list as component, index (component.cid)}
                        {#if component.search }
                            <div id={component.cid+"_search"} 
                                ...
                                <svelte:component this={component.search} on:search={paramFromSearchFunc}/>
                            </div>
                        {/if}
                    {/each}
                    </div>
        ...
        ">
            {#each $menuStore.list as component, index (component.cid)}
                ...
                >
                    {#if component.search }
                        <svelte:component this={component.component} {paramFromSearch}/>
                    {:else}
